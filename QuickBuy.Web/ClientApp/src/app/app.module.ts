...
import { RouterModule } from '@angular/router';               // para navegar entre as paginas
import { TruncateModule } from "ng2-truncate";                // para truncar descrição do produto na loja
